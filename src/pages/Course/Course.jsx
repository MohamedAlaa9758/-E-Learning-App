...
const cardItem = [
  {
    ...
    title: "Design",
    des: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmodadipiscing elit, sed do eiusmod",
  },
  {
    color: "bg-[#CED5FA]",
    svg: (
                ...
                return (
                  <div key={index} className="w-1/2 md:w-1/3 lg:w-1/4">
                    <div className="inner bg-bg-primary rounded-2xl shadow-xl m-3 py-5">
                      <FavCourse colorBox={item.color} svg={item.svg} title={item.title} desc={item.des} />
                    </div>
                  </div>
                );
              })}
